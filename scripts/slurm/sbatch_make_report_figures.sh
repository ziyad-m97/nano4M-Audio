...
#SBATCH --output=/path/to/home/logs/report_figs_%j.out
#SBATCH --error=/path/to/home/logs/report_figs_%j.err
...
python make_report_figures.py --only 1 2 3 4
